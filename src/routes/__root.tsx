...
import { GrowthAdvisorChatbot } from "@/components/growth-advisor-chatbot";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Bamietech IT Solutions" },
      ...
      { name: "twitter:site", content: "@BITSgo" },
    ],
    links: [
      {
        rel: "stylesheet",
